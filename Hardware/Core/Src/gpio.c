...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, DEBUG_LED_Pin|WRITE_EN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(READ_EN_GPIO_Port, READ_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(INTA_GPIO_Port, INTA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PXX5_Pin BUTTON_TEST_Pin */
  GPIO_InitStruct.Pin = PXX5_Pin|BUTTON_TEST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  HAL_GPIO_Init(READ_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : WRITE_EN_Pin */
  GPIO_InitStruct.Pin = WRITE_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(WRITE_EN_GPIO_Port, &GPIO_InitStruct);
