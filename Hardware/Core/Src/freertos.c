...
/* Definitions for STEP_MOTOR1TIM1 */
osTimerId_t STEP_MOTOR1TIM1Handle;
const osTimerAttr_t STEP_MOTOR1TIM1_attributes = {
  .name = "STEP_MOTOR1TIM1"
};
/* Definitions for STEP_MOTOR1TIM2 */
osTimerId_t STEP_MOTOR1TIM2Handle;
const osTimerAttr_t STEP_MOTOR1TIM2_attributes = {
  .name = "STEP_MOTOR1TIM2"
};
/* Definitions for STEP_MOTOR2TIM1 */
osTimerId_t STEP_MOTOR2TIM1Handle;
const osTimerAttr_t STEP_MOTOR2TIM1_attributes = {
  .name = "STEP_MOTOR2TIM1"
};
/* Definitions for STEP_MOTOR2TIM2 */
osTimerId_t STEP_MOTOR2TIM2Handle;
const osTimerAttr_t STEP_MOTOR2TIM2_attributes = {
  .name = "STEP_MOTOR2TIM2"
};
/* Definitions for STEP_MOTOR3TIM1 */
osTimerId_t STEP_MOTOR3TIM1Handle;
const osTimerAttr_t STEP_MOTOR3TIM1_attributes = {
  .name = "STEP_MOTOR3TIM1"
};
/* Definitions for STEP_MOTOR3TIM2 */
osTimerId_t STEP_MOTOR3TIM2Handle;
const osTimerAttr_t STEP_MOTOR3TIM2_attributes = {
  .name = "STEP_MOTOR3TIM2"
};
...
void STEP_MOTOR1TIM1fun(void *argument);
void STEP_MOTOR1TIM2fun(void *argument);
void STEP_MOTOR2TIM1fun(void *argument);
void STEP_MOTOR2TIM2fun(void *argument);
void STEP_MOTOR3TIM1fun(void *argument);
void STEP_MOTOR3TIM2fun(void *argument);
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    ...
    if (GPIO_Pin == LIGHT_SENSOR_Pin)
    {
        ...
        HAL_UART_Transmit(&huart1, cmd[0], 7, HAL_MAX_DELAY);
    }
}
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the timer(s) */
  /* creation of STEP_MOTOR1TIM1 */
  STEP_MOTOR1TIM1Handle = osTimerNew(STEP_MOTOR1TIM1fun, osTimerOnce, NULL, &STEP_MOTOR1TIM1_attributes);

  /* creation of STEP_MOTOR1TIM2 */
  STEP_MOTOR1TIM2Handle = osTimerNew(STEP_MOTOR1TIM2fun, osTimerOnce, NULL, &STEP_MOTOR1TIM2_attributes);

  /* creation of STEP_MOTOR2TIM1 */
  STEP_MOTOR2TIM1Handle = osTimerNew(STEP_MOTOR2TIM1fun, osTimerOnce, NULL, &STEP_MOTOR2TIM1_attributes);

  /* creation of STEP_MOTOR2TIM2 */
  STEP_MOTOR2TIM2Handle = osTimerNew(STEP_MOTOR2TIM2fun, osTimerOnce, NULL, &STEP_MOTOR2TIM2_attributes);

  /* creation of STEP_MOTOR3TIM1 */
  STEP_MOTOR3TIM1Handle = osTimerNew(STEP_MOTOR3TIM1fun, osTimerOnce, NULL, &STEP_MOTOR3TIM1_attributes);

  /* creation of STEP_MOTOR3TIM2 */
  STEP_MOTOR3TIM2Handle = osTimerNew(STEP_MOTOR3TIM2fun, osTimerOnce, NULL, &STEP_MOTOR3TIM2_attributes);
...
void StartDefaultTask(void *argument)
{
  /* USER CODE BEGIN StartDefaultTask */
    ...
    for (;;)
    {
        if(received_num != 0xFF)
        {
            switch (received_num)
            {
            case 0:
                osTimerStart(STEP_MOTOR1TIM1Handle, 100);  // 100ms 后通知正转
                osTimerStart(STEP_MOTOR1TIM2Handle, 1000); // 1000ms 后通知反转
                break;
            case 1:
                osTimerStart(STEP_MOTOR2TIM1Handle, 100);
                osTimerStart(STEP_MOTOR2TIM2Handle, 1000);
                break;
            case 2:
                osTimerStart(STEP_MOTOR3TIM1Handle, 100);
                osTimerStart(STEP_MOTOR3TIM2Handle, 1000);
                break;
            case 3:
                break;
            default:
            ...
            received_num= 0xFF; // Reset the received number after processing
        }
        osDelay(1);
...
/* STEP_MOTOR1TIM1fun function */
void STEP_MOTOR1TIM1fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR1TIM1fun */
  osThreadFlagsSet(STEP_MOTOR1Handle, 0x01);
  /* USER CODE END STEP_MOTOR1TIM1fun */
}

/* STEP_MOTOR1TIM2fun function */
void STEP_MOTOR1TIM2fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR1TIM2fun */
  osThreadFlagsSet(STEP_MOTOR1Handle, 0x02);
  /* USER CODE END STEP_MOTOR1TIM2fun */
}

/* STEP_MOTOR2TIM1fun function */
void STEP_MOTOR2TIM1fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR2TIM1fun */
  osThreadFlagsSet(STEP_MOTOR2Handle, 0x01);
  /* USER CODE END STEP_MOTOR2TIM1fun */
}

/* STEP_MOTOR2TIM2fun function */
void STEP_MOTOR2TIM2fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR2TIM2fun */
  osThreadFlagsSet(STEP_MOTOR2Handle, 0x02);
  /* USER CODE END STEP_MOTOR2TIM2fun */
}

/* STEP_MOTOR3TIM1fun function */
void STEP_MOTOR3TIM1fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR3TIM1fun */
  osThreadFlagsSet(STEP_MOTOR3Handle, 0x01);
  /* USER CODE END STEP_MOTOR3TIM1fun */
}

/* STEP_MOTOR3TIM2fun function */
void STEP_MOTOR3TIM2fun(void *argument)
{
  /* USER CODE BEGIN STEP_MOTOR3TIM2fun */
  osThreadFlagsSet(STEP_MOTOR3Handle, 0x02);
  /* USER CODE END STEP_MOTOR3TIM2fun */
}
